...
public class MaTCGenerator implements IdentifierGenerator {
    ...
    public Object generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o) {
        if(o instanceof Traicay) {
            ...
            return ((Traicay) o).getLoaiTraiCay_TraiCay().getMaloaiTc() + "-" + ((Traicay) o).getSize() + "-" + hashMap.get(((Traicay) o).getXuatXu()) + "-" + datePart + "-" + ((Traicay) o).getTinhTrang();
        } else{
            return null;
        }
    }
